...
function mostrarEventos(eventos) {
  ...
  for (let i = 0; i < eventos.length; i++) {
    ...
    tarjeta.innerHTML = `
      <img src="${eventos[i].image}" class="card-img-top h-40 object-fit-cover" alt="${eventos[i].category}">
      ...
      <div class="card-body d-flex flex-column">
        ...
        <a href="./page4.html?id=${eventos[i]._id}" class="btn btn-primary w-50">Details</a>
      </div>`;
...
function filtrarEventos() {
  ...
  let eventosFiltrados = data.eventos.filter(evento => {
