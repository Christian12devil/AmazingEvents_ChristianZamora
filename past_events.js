document.addEventListener("DOMContentLoaded", function () {
  ...
  for (let i = 0; i < data.events.length; i++) {
    ...
    card.className = "card";
    card.innerHTML = `<div class="items_container">
    <div class="item">
      <img class="item_img" src="${event.image}">
      <h3 class="item_h3">${event.name}</h3>
      <p>${event.description}</p>
      <div class="item_details">
      <span>$${event.price}</span>
      <a class="item_details_a" href="./page4.html">Details</a>
      </div>
    </div>  
</div>`;
